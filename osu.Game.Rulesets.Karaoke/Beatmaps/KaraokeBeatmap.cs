...
{
    public string? UtaPackageId { get; set; }

    public bool UtaOctaveTolerance { get; set; }

    public string? UtaGuideVocalsFile { get; set; }

    public string? UtaOriginalAudioFile { get; set; }

    public IReadOnlyList<UtaTranscriptSegment> UtaTranscriptSegments { get; set; } = Array.Empty<UtaTranscriptSegment>();

    public int UtaCentreMidi { get; set; } = 60;
