...
public partial class NotePlayfield : ScrollingNotePlayfield, IKeyBindingHandler<KaraokeScoringAction>
{
    ...
    public bool OnPressed(KeyBindingPressEvent<KaraokeScoringAction> e)
    {
        ...
        // This playfield only mirrors the microphone action for the legacy visualisation.
        // Leave the action unhandled so the active DrawableNote can score it as well.
        return false;
    }
