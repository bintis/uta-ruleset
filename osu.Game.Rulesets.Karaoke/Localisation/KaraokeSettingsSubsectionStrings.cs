...
public static class KaraokeSettingsSubsectionStrings
{
    ...
    /// </summary>
    public static LocalisableString MicrophoneMonitorVolume => new TranslatableString(getKey(@"microphone_monitor_volume"), @"Microphone monitor volume");

    /// <summary>
    /// "Hear your microphone through the current audio output. Headphones are strongly recommended."
    /// </summary>
    public static LocalisableString MicrophoneMonitorVolumeTooltip => new TranslatableString(
        getKey(@"microphone_monitor_volume_tooltip"),
        @"Hear your microphone through the current audio output. Headphones are strongly recommended."
    );
