...
public class KaraokeRulesetConfigManager : RulesetConfigManager<KaraokeRulesetSetting>
{
    ...
    protected override void InitialiseDefaults()
    {
        ...
        // Visual
        SetDefault(KaraokeRulesetSetting.ScrollTime, 7000.0, 1000.0, 14000.0, 100.0);
        ...
        SetDefault(KaraokeRulesetSetting.BackgroundMusicVolume, 1.0, 0.0, 1.0, 0.01);
        SetDefault(KaraokeRulesetSetting.GuideVoiceVolume, 0.55f, 0f, 1f, 0.01f);

        // Device
        SetDefault(KaraokeRulesetSetting.MicrophoneDevice, string.Empty);
        SetDefault(KaraokeRulesetSetting.MicrophoneInputGain, 1.5f, 0.5f, 3f, 0.05f);
        SetDefault(KaraokeRulesetSetting.MicrophoneMonitorVolume, 0.35f, 0f, 1f, 0.01f);
    ...
    public override TrackedSettings CreateTrackedSettings() => new()
    {
        ...
        new TrackedSetting<float>(KaraokeRulesetSetting.MicrophoneInputGain, v => new SettingDescription(v, "Microphone input gain", $"{v:P0}")),
        new TrackedSetting<float>(KaraokeRulesetSetting.MicrophoneMonitorVolume, v => new SettingDescription(v, "Microphone monitor", $"{v:P0}")),
        new TrackedSetting<double>(KaraokeRulesetSetting.BackgroundMusicVolume, v => new SettingDescription(v, "Background music", $"{v:P0}")),
        new TrackedSetting<float>(KaraokeRulesetSetting.GuideVoiceVolume, v => new SettingDescription(v, "Guide voice", $"{v:P0}")),
    };
}
