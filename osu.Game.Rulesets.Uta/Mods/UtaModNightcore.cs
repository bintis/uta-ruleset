...
/// <see cref="UtaModPracticeSpeed"/> already covers every rate from 50% to 150%). BGM/VOX sync
/// comes for free from <see cref="UI.UtaAudioController"/>, which already tracks the gameplay
/// clock's rate generically for any rate-adjusting mod.
/// </summary>
